...
The system we will construct mathematically and depicted by \shortfigref{system} is a simple pendulum, which means that there is a point mass at the end of a massless rod. A compound pendulum can be similarly derived by just substituting the position of the point masses by the position of the centers of mass \cite{wikidp}.
